...
public class DirectedAdjacencyListGraph <E extends Edge> extends AdjacencyGraph<E> {
    ...
    private LinkedList<E>[] adjacency;

    protected LinkedList<E>[] adjacency() { return adjacency; }
    protected void setAdjacency(LinkedList<E>[] adjacency) { this.adjacency = adjacency; }

public class AppController {
    ...
    private Coloring coloring(){ return this.coloring; }
    private void setColoring(Coloring aColoring){ this.coloring = aColoring; }
    ...
    private void showColoring(){
        ...
        if(this.coloring().sameColorEdges().size() == 0)
            AppView.outputLine("! 모든 edge의 양 끝 vertex의 색이 다릅니다.");
        else{

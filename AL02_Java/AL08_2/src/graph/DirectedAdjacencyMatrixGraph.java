...
public class DirectedAdjacencyMatrixGraph<E extends Edge> extends AdjacencyGraph<E> {
    ...
    public boolean edgeDoesExist(E anEdge){
        if(anEdge != null) return (this.adjacencyOfEdgeDoesExist(anEdge.tailVertex(), anEdge.headVertex()));
        return false;
    }
    @Override
    ...
    private class IteratorForNeighborsOf implements Iterator<E>{
        ...
        private void setNextHeadVertex(int newNextHeadVertex) { this._nextHeadVertex = newNextHeadVertex; }
        ...
        public boolean hasNext() {
            while(this.nextHeadVertex()< DirectedAdjacencyMatrixGraph.this.numberOfVertices()){
                if(DirectedAdjacencyMatrixGraph.this.adjacencyOfEdgeDoesExist(this.tailVertex(),this.nextHeadVertex())) return true;

...
public class ParameterSetForMeasurement extends ParameterSetForIteration {
    ...
    private static final int DEFAULT_NUMBER_OF_REPETITION_IF_SINGLE_SORT =1;
    ...
    public ParameterSetForMeasurement(){
        super();
        this.setNumberOfRepetitionOfSingleSort(DEFAULT_NUMBER_OF_REPETITION_IF_SINGLE_SORT);
    }
